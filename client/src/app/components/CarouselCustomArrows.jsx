...
export default function CarouselCustomArrows() {
  return (
    <Carousel
      navigation={() => <></>}
      className="rounded-xl w-[70%] mx-auto lg:w-[40%] lg:mt-[2rem] xl:w-[35%] ol:w-[40%] 2xl:!w-[32%] xxl:mt-[1rem]  xxxl:mt-[4rem]"
      prevArrow={({ handlePrev }) => (
        <IconButton
          ...
          size="lg"
          onClick={handlePrev}
          className="!absolute top-2/4 left-4 -translate-y-20  !rounded-full bg-[#585c5f] w-[2rem] h-[2rem] sm:w-[2rem] sm:h-[2rem] md:w-[2.2rem] md:h-[2.2rem] lg:w-[2rem] lg:h-[2rem] lg:top-[35%] ol:w-[2.5rem] ol:h-[2.5rem] ol:top-[40%] xxl:w-[2.5rem] xxl:h-[2.5rem] xxxl:top-[35%]"
        >
          <svg
      ...
      nextArrow={({ handleNext }) => (
        <IconButton
          ...
          size="lg"
          onClick={handleNext}
          className="!absolute top-2/4 !right-4 -translate-y-20 !rounded-full bg-[#585c5f] w-[2rem] h-[2rem] sm:w-[2rem] sm:h-[2rem] md:w-[2.2rem] md:h-[2.2rem] lg:w-[2rem] lg:h-[2rem] lg:top-[35%]  ol:w-[2.5rem] ol:h-[2.5rem] ol:top-[40%] xxl:w-[2.5rem] xxl:h-[2.5rem] xxxl:top-[35%]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
