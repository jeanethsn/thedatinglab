      ...
      <div className="flex flex-col justify-center items-center max-w-[20rem] sm:max-w-[30rem] lg:basis-[55%] lg:pt-[2rem] ol:max-w-[45rem] xl:pb-[4rem]">
        ...
        <div className="relative">
          <div className="flex gap-[1rem] mb-[2rem] sm:items-center ol:mb-[4rem]">
            <Image
              ...
              alt="numero uno"
              className="h-auto sm:w-[2rem] lg:w-[1.5rem] ol:w-[1.8rem]"
            />
          ...
          <Image
            ...
            alt="icono flecha"
            className="h-auto absolute top-2 right-0 sm:w-[4rem] sm:right-[4rem] lg:right-[3rem] lg:w-[3.5rem] ol:w-[4.5rem] ol:right-[1rem]"
          />
        </div>
        <div className="relative sm:w-full">
          <div className="flex gap-[1rem] mb-[2rem] justify-end sm:items-center ol:mb-[4rem]">
            <Image
              ...
              alt="numero dos"
              className="h-auto sm:w-[3rem] lg:w-[2.3rem] ol:w-[2.5rem]"
            />
          ...
          <Image
            ...
            alt="icono de flecha"
            className="h-auto absolute top-6 left-0 sm:w-[6rem] sm:top-[1rem] lg:top-[1rem] lg:w-[5rem] ol:left-[8rem] ol:w-[6rem]"
          />
        </div>
        <div className="flex gap-[1rem] mb-[2rem] sm:items-center lg:pb-[1rem]">
          <Image
            ...
            alt="numero tres"
            className="h-auto lg:w-[2.3rem] ol:w-[2.5rem]"
          />
